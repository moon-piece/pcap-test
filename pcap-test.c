 ...
 */
struct libnet_ethernet_hdr   // libnet-headers.h > struct libnet_ethernet_hdr
{
 ...
 */
struct libnet_ipv4_hdr   // libnet-headers.h > struct libnet_ipv4_hdr
{
 ...
 *  Static header size: 20 bytes
 */
struct libnet_tcp_hdr  // libnet-headers.h > struct libnet_tcp_hdr
{
